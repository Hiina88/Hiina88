...
- 初期サンプルプロンプト 78 件(Codex Cloud 15 / Xポスト 8 / Instagram・SNS 7 / 長文記事 9 / 画像生成 5 / 動画生成 4 / 講座作成 4 / LP/セールス 5 / リサーチ 4 / 文章改善 4 / モデル別プロンプト 13)
- モデル別プロンプト: Claude Opus 4.7 / ChatGPT 5.5 / Claude Code / OpenAI Codex の使い分けチートシート + 各モデル向け基本テンプレート + 実践例 + ユースケース別(コードレビュー / テスト生成 / ドキュメント生成)
